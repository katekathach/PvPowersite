...
<?php
	...
	if ($job != "") {
		...
		function saveProjectDetails($_GET, $userID, $db_connection, $system,$isUpdate) {
			...
			if(isset($_GET['cell'])){ $query .= "project_cell_type= '" .  $_GET['cell'] ."', ";
			}
			...
			if (isset($_GET['modulecount'])) { $query .= " project_column= '" . mysqli_real_escape_string($db_connection, $_GET['modulecount']) . "',";
			}
			if (isset($_GET['tilt'])) { $query .= "project_tilt= '" . mysqli_real_escape_string($db_connection, $_GET['tilt']) . "',";
			}
			if (isset($_GET['foundation'])) { $query .= "project_foundation= '" . mysqli_real_escape_string($db_connection, $_GET['foundation']) . "',";
			}
			...
			if (isset($_GET['windvalue'])) { $query .= "project_wind_load= '" . mysqli_real_escape_string($db_connection, $_GET['windvalue']) . "',";
			}
			if (isset($_GET['snow'])) { $query .= "project_snow_load= '" . mysqli_real_escape_string($db_connection, $_GET['snow']) . "',";
			}
			if (isset($_GET['racksqty'])) { $query .= "project_num_racks= '" . mysqli_real_escape_string($db_connection, $_GET['racksqty']) . "',";
			}
		...
		function updateproject($_GET ,$db_connection , $isUpdate , $userID ,$system){
			...
			if(isset($isUpdate)){
				...
				$query .= "`project_state`='".$_GET['State']."',`project_zip`='".$_GET['projzip']."',`project_cell_type`='".$_GET['cell']."',`project_tilt`='".$_GET['tilt']."',";
				$query .= "`project_thickness`='".$_GET['modulethickness']."',`project_width`='".$_GET['modulewidth']."',";
				$query .= "`project_column`='".$_GET['modulecount']."',`project_building_code`='".$_GET['codeversion']."',`project_seis`='".$_GET['seismic']."',";
				$query .= "`project_wind_load`='".$_GET['windvalue']."',`project_snow_load`='".$_GET['snow']."',`project_num_racks`='".$_GET['racksqty']."',`project_system_id`='".$system."',";
